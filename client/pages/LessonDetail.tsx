  ...
  "1": {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "fill-in-blank",
        question:
          "JavaScript is a ________ language used to add interactivity to web pages.",
  ...
  "2": {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "fill-in-blank",
        question:
          "Props are used to pass data from a ________ component to a child component.",
    ...
    questions: [
      {
        ...
        options: [
          "A way to create reusable components with types",
          "A type of loop",
      ...
      },
      {
        ...
        type: "fill-in-blank",
        question:
          "The ________ keyword is used to create a new instance of a class.",
        correctAnswer: "new",
      },
      {
        id: "q3",
        ...
        options: [
          "A contract that defines the structure of objects",
          "A CSS property",
          "A DOM element",
